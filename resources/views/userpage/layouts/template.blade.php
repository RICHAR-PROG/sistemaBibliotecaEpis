    ...
    <nav class="navbar navbar-expand-lg shadow">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link nav-link-1 active" aria-current="page" href="{{route('userpage.index')}}">Catalogos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-2" href="{{route('prestamos.index')}}">Historial</a>
                </li>
                <li class="nav-item">
        ...
        <div class="container-fluid tm-container-small">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-7 col-12 px-5 mb-3">
                    <p class="text-center">©Copyright {{date('Y')}} EQUIPO 5. Todos los derechos reservados.</p>
                </div>
